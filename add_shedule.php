...
<body>
	...
	<form method="POST" action="add_shedule_connect.php">
        <h2>Add Shedule</h2>
<input type="text" placeholder="Shedule Name"id="t1" name="name"><br><br>
<input type="text" name="M"id="t1"placeholder="Monday"><br><br>
<input type="text" name="Tu"id="t1"placeholder="Tuesday"><br><br>
<input type="text" name="W"id="t1"placeholder="Wednesday"><br><br>
<input type="text" name="Thu"id="t1"placeholder="Thursday"><br><br>
<input type="text" name="F"id="t1"placeholder="Friday"><br><br>
<input type="text" name="Sa"id="t1"placeholder="Saturday"><br><br>
<input type="text" name="Su"id="t1"placeholder="Sunday"><br><br>
  <input type="submit" name="submit"id="su1">
</form>
