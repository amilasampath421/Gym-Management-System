...
<a href="profile.php?user_id=<?php echo $user_id?>" class="<?php if($page == ''): echo 'active';endif; ?>">Profile</a>
           ...
           <a href="shedule.php?user_id=<?php echo $user_id ?>" class="<?php if($page == ''): echo 'active';endif; ?>">Shedule</a>

           <a href="payment.php?user_id=<?php echo $user_id?>" class="<?php if($page == ''): echo 'active';endif; ?>">Payment</a>
            </div>
			</div>
            <h2 id="schtop">Weekly Workout Schedules</h2>
			<?php 
                ...
                if($res){
                    ...
                    if($count>0){
                        while($rows=mysqli_fetch_assoc($res)){
                            ...
                            ?>
                                <div class="shed">
                                    <h3 id="schhed"><?php echo $rows['Name'];?></h3>
                                    <div>
                                        <table>
                                            
                                            <tr><td ID="SDETAILS"><?php echo "Monday     "?></td><td ID="SDETAILS"><?php echo $rows['Monday'];?></td></tr>
                                            <tr><td ID="SDETAILS"><?php echo "Tuesday "?></td><td ID="SDETAILS"><?php echo $rows['Tuesday'];?></td></tr>
                                            <tr><td ID="SDETAILS"><?php echo "Wednesday "?></td><td ID="SDETAILS"><?php echo $rows['Wednesday']?></td></tr>
                                            <tr><td ID="SDETAILS"><?php echo "Thursday "?></td><td ID="SDETAILS"><?php echo $rows['Thursday'];?></td></tr>
                                            <tr><td ID="SDETAILS"><?php echo "Friday "?></td><td ID="SDETAILS"><?php echo $rows['Friday'];?></td></tr>
                                            <tr><td ID="SDETAILS"><?php echo "Saturday "?></td><td ID="SDETAILS"><?php echo $rows['Saturday'];?></td></tr>
                                            <tr><td ID="SDETAILS"><?php echo "Sunday "?></td><td ID="SDETAILS"><?php echo $rows['Sunday'];?></td></li>
                                        </table>
