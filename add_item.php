...
<div id="f1">
	    ...
	    <form method="POST" id="aa" action="add_item_connect.php?user_id=<?php echo $user_id?>" enctype="multipart/form-data">
	    <input type="text" id="bb" placeholder="Item Name" name="name"><br><br>
        <input type="file" id="cc" placeholder="Image" name="image"><br><br>
