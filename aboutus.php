...
<div class="aboutus">
    <h1>About Us</h1>
    <p>A university gym management system is a software tool designed to help university fitness centers manage their operations more efficiently. These systems typically include features such as membership management, equipment tracking, scheduling and booking, workout tracking, and reporting and analytics. University gym management systems aim to streamline administrative tasks and improve the overall experience for students and faculty using the gym facilities. They also provide universities with valuable data and insights to help them 
        optimize their fitness center operations.</p>
