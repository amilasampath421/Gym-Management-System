			...
			if($result)
			{
				if($result && mysqli_num_rows($result)>0)
				{
					...
					if($user_data['password'] === $password)
					{
						...
						header("Location: afterlog.php?user_id=$user_id");
						die;
					}
				}
			}
...
<div id="box">
      ...
      <tr>
        <td>
        <p id="a02"class="regtext">Do You Have An Account?</p>
        </td>
      </tr>
      <tr>
        <td>
        <a href="signup.php" id="p02"class="regtext">Register</a>
        </td>
      </tr>
