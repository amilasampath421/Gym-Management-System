...
<a href="profile.php?user_id=<?php echo $user_id?>" class="<?php if($page == ''): echo 'active';endif; ?>">Profile</a>
           ...
           <a href="payment.php?user_id=<?php echo $user_id?>" class="<?php if($page == ''): echo 'active';endif; ?>">Payment</a>
            ...
            <div class="webbody">
                        <?php  
                            $query = "select name_with_initials,nic,date_of_birth,weight,height,email,mobile_number,faculty from users where id = '$user_id'";
                            $result = @mysqli_query($con,$query);
                            $row= mysqli_fetch_array($result);
                            ?>
                            <ul class="myul">
                            <li><img class="myimg" src="photos/man.png" alt=""></li><br>
                               <li>Name: <?php echo $row['name_with_initials'];?></li><br>
                               <li>NIC: <?php echo $row['nic'];?></li><br>
                               <li>DOB: <?php echo $row['date_of_birth'];?></li><br>
                               <li>Weight: <?php echo $row['weight'];?></li><br>
                               <li>Height: <?php echo $row['height'];?></li><br>
                               <li>Email: <?php echo $row['email'];?></li><br>
                               <li>Mobile Number: <?php echo $row['mobile_number'];?></li><br>
                               <li>Faculty: <?php echo $row['faculty'];?></li><br>
                            </ul>
